...
<section class="content">
    ...
    <div class="container-fluid">
       <div class="card">
            ...
            <form action="" method="get">
                <div class="card-header">
                    <div class="card-title">
                        ...
                        <button type="button" onclick="window.location.href=pageIndexRoute" class="btn btn-default btn-sm">Reset</button>
                    </div>
          ...
          {{ $pages_admin->links('vendor.pagination.custom_admin') }}
       </div>
    </div>
    <!-- /.card -->
</section>
...
@section('customJs')
    ...
    <script>
        var pageIndexRoute = "{{ route('pages.index') }}";
