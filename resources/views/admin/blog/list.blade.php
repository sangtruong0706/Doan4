        ...
        <div class="container-fluid">
            ...
            <div class="card">
                ...
                <form action="" method="get">
                    <div class="card-header">
                        <div class="card-title">
                            ...
                            <button type="button" onclick="window.location.href=blogIndexRoute" class="btn btn-default btn-sm">Reset</button>
                        </div>
                            ...
                            @if ($blogs->isNotEmpty())
                                @foreach ($blogs as $blog)
                                    <tr>
                                        ...
                                        <td>
                                            @if (!empty($blog->image))
                                                <img src="{{ asset('uploads/blog/'.$blog->image) }}" class="img-thumbnail" width="50" >
                                            @else
                ...
                <div class="card-footer clearfix">
                    {{ $blogs->links('vendor.pagination.custom_admin') }}
                </div>
            </div>
        </div>
        <!-- /.card -->
...
<script>
    var blogIndexRoute = "{{ route('blogs.index') }}";
