                ...
                <form action="" method="get">
                    <div class="card-header">
                        <div class="card-title">
                            ...
                            <button type="button" onclick="window.location.href=couponIndexRoute" class="btn btn-default btn-sm">Reset</button>
                        </div>
                                ...
                                @foreach ($discountCoupons as $discountCoupon)
                                    <tr>
                                        ...
                                        <td>
                                            ...
                                            @else
                                                {{ number_format($discountCoupon->discount_amount, 0, ',','.') }} vnđ
                                            @endif
                                        </td>
                                        <td>
...
<script>
    var couponIndexRoute = "{{ route('coupons.index') }}";
