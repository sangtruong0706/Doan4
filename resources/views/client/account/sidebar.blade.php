<ul id="account-panel" class="nav nav-pills flex-column" >
    ...
    <li class="nav-item">
        <a href="{{ route("account.orders") }}"  class="nav-link font-weight-bold {{ request()->routeIs('account.orders') ? 'active' : '' }}" role="tab" aria-controls="tab-register" aria-expanded="false"><i class="fas fa-shopping-bag"></i>My Orders</a>
    </li>
    <li class="nav-item">
